...
echo "export APP_NAME=cp-tsdata-demo-1" > ops/cloud-app-instances/$APP_NAME/released-app/cfg/env.sh

echo "export APP_VERSION=v1" >> ops/cloud-app-instances/$APP_NAME/released-app/cfg/env.sh
